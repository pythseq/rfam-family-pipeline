...
=head2 writeAnnotatedCM

  Title    : writeAnnotatedCM
  Incept   : EPN, Wed May 28 09:20:28 2014/swb Friday 6th June 2014
  Usage    : Bio::Rfam::Family::CM::writeAnnotatedCM($cm, $familyObj, $outfile, $do_append)
  Function : Output a CM to a file. Most work is done by writeCM(), after modifying
           : names and cutoffs.
  Args     : $self:       Bio::Rfam::FamilyIO object
           : $familyObj:  Bio::Rfam::Family Object
  ...
  Dies     : If $outfile is not defined, or if somehow we have some E-value stat lines but not all of them
           : or if any of ID, ACC, CUTGA, CUTNC, or CUTTC are not defined the $familyObj->{DESC} object.
=cut
...
=head2 writeCM
  ...
  Usage    : Bio::Rfam::Family::CM::writeCM($cm, $outfile, $do_append)
